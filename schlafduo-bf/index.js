...
`
    ...
    const discountPercent = 0.3 // hier noch korrekten Wert einfügen
    ...
    const itemString = Object.values(cart)
      ...
      .join(",")
    const discountCode = "schlafduo-bf" // hier Gutscheincode eintragen
    const url =
  ...
  const addToCartButtons = ["cart-button-1", "cart-button-2"]
